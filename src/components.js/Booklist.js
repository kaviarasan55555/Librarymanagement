                            ...
                            <div className="card" style={{ width: "22rem" }}>
                                ...
                                <ul className="list-group list-group-flush">
                                    ...
                                    <li className="list-group-item">
                                        <Link to='/Editbook'><span className='btn btn-danger m-2' onClick={()=>setEditid(b.id)}>Edit</span></Link>
                                        <Link><span className='btn btn-primary' onClick={()=>{Bookdelete(b.id)}}>Delete</span></Link>
                                    </li>
                                </ul>
